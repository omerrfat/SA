...
const ScrollStack: React.FC<ScrollStackProps> = ({
    ...
    const updateCardTransforms = useCallback(() => {
        ...
        cardsRef.current.forEach((card, i) => {
            ...
            if (!card || cardTop === undefined) return;
            ...
            if (hasChanged) {
                ...
                const filter = newTransform.blur > 0 ? `blur(${newTransform.blur.toFixed(2)}px)` : 'none';
    ...
    useLayoutEffect(() => {
        ...
        const cards = cardsRef.current.length
            ? cardsRef.current
            : Array.from(document.querySelectorAll('.scroll-stack-card')) as HTMLElement[];
        ...
        const positionCacheTimeout = setTimeout(updatePositions, 100);
        ...
        return () => {
            clearTimeout(positionCacheTimeout);
    ...
    return (
        ...
        >
            <div className="scroll-stack-inner pt-[20vh] pb-[50vh] min-h-screen">
                {children}
